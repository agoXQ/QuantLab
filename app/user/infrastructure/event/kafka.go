// Package event provides a Kafka-backed implementation of the User
// domain event publisher and a Noop fallback. Mirrors the shape used
// by Strategy / Backtest / Market so consumers across services share
...
func NewKafkaPublisher(brokers []string) domevent.Publisher {
	return &kafkaPublisher{
		writer: &kafka.Writer{
			...
			Topic:        domevent.TopicUserEvents,
			Balancer:     &kafka.Hash{},
